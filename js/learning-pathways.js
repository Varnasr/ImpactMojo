...
(function () {
  ...
  function renderPaidCard() {
    return '<a class="imx-pw-paid-card" href="/ai-for-me-certificate.html" ' +
      ...
      '<span style="position:absolute;top:1rem;right:1.1rem;font-size:0.58rem;font-weight:700;letter-spacing:0.6px;text-transform:uppercase;background:rgba(245,158,11,0.15);color:#B45309;padding:0.18rem 0.5rem;border-radius:5px;">Paid · Verified</span>' +
      '<div style="font-weight:700;font-size:1.05rem;margin-bottom:0.15rem;">AI for M&E — Assessed Track</div>' +
      ...
      '<div style="margin-top:auto;display:flex;align-items:center;justify-content:space-between;gap:0.5rem;">' +
        '<span style="font-weight:700;color:#B45309;">₹2,499 <span style="font-weight:400;font-size:0.75rem;color:var(--text-secondary);">one-time</span></span>' +
        '<span style="font-size:0.82rem;font-weight:600;color:#F59E0B;">View the track →</span>' +
      '</div>' +
    '</a>';
  }
