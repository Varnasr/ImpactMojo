...
(function () {
  ...
  var TOURS = {
    index: [
      ...
      { element: '#nav-learn', intro: '<strong>Learn</strong><br>The heart of the platform: 71 courses (19 flagship + 52 foundational), interactive studios, and practice packs.' },
