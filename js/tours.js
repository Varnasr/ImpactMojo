...
(function () {
  ...
  var TOURS = {
    index: [
      { intro: '<strong>Welcome to ImpactMojo!</strong><br>Development know-how for South Asia — 69 courses, 135 games and 35 labs, all free, built by practitioners. Here’s a quick lay of the land.' },
      { element: '#nav-learn', intro: '<strong>Learn</strong><br>The heart of the platform: 69 courses (18 flagship + 51 foundational), interactive labs, and practice packs.' },
      ...
      { element: '#nav-labs', intro: '<strong>Labs</strong><br>35 labs where you build real artefacts — a Theory of Change, a LogFrame, a sampling plan, a survey instrument.' },
      ...
      { element: '.ims-nav-btn', intro: '<strong>Search everything</strong><br>Press <kbd>Ctrl</kbd>+<kbd>K</kbd> anywhere to search across every course, lab, game and companion.' },
