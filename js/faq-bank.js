(function(){
  ...
  const FAQ = [
    ...
    { re: /\b(price|cost|fee|paid|free).+premium|\bpremium.+(price|cost|fee)/i,
      a: "Premium has two tiers: **Practitioner** and **Professional**. Pricing and full details are on the live Premium page. All 16 flagship courses, 101-level courses, labs, and games remain **free** forever." },
