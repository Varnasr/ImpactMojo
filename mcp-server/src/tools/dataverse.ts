...
export function registerDataverseTools(server: McpServer, data: LoadedData) {
  server.tool(
    "browse_dataverse",
    "Browse ImpactMojo's Dataverse catalog of 324 tools, datasets, APIs, and MCP servers for development research. Filter by category, type, or free-only.",
    {
  ...
  server.tool(
    "search_dataverse",
    "Keyword search across 324 dataverse items — tools, datasets, APIs, and MCP servers for development research.",
    {
