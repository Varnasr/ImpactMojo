...
It lives at [impactmojo.in/impactlex](https://www.impactmojo.in/impactlex/), installs as a Progressive Web App (PWA) for offline use, and draws on the same term pool as the 15 flagship ImpactMojo course lexicons — so what you learn in the MEL course shows up consistently wherever that term appears.
