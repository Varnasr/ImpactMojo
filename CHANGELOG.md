...
- With this, **every dead external link found in the DeepDives audit is resolved**: 30 confirmed 404s → 5 fixed in #922, 11 in #924, 13 here, and 1 (`linkedin.com/company/impactmojo`) pending the correct handle.
